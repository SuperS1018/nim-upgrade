...
class ProductCommanderTeams extends Component {
  render () {
    const { commanderTeams: { pageBanner, tableComparison, content } } = this.props.fields
    return (
      <div className='Product Commander Teams page'>
...
export default ProductCommanderTeams
