...
class ProductCommanderCli extends Component {
  render () {
    const { commanderCli: { pageBanner, tableComparison, content } } = this.props.fields
    return (
      <div className='Product Commander Cli page'>
...
export default ProductCommanderCli
