...
class PricingCommanderTeams extends Component {
  constructor (props) {
    super(props)
    this.state = {
      teamId: '',
  ...
  handleClick = (index) => {
    switch(index) {
      case 0:
        break
      case 1:
        googleAnalyticsEvent(0, 'Pricing Teams', 'Contact Us')
  ...
  render () {
    ...
    return (
      <div className='PricingCommander Teams page'>
        <PricingComparison tableList={pricingTable} comparisonList={comparisonTable} handleClick={this.handleClick} showButton={showButton} pageName={'Commander for Teams'} />
...
export default withRouter(PricingCommanderTeams)
