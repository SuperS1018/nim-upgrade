...
class ProductCommanderSlack extends Component {
  render () {
    const { commanderSlack: { pageBanner, tableComparison, content } } = this.props.fields
    return (
...
export default ProductCommanderSlack
